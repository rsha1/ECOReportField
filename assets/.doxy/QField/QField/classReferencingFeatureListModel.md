...
| Type | Name |
| ---: | :--- |
| property QString | [**attachmentFieldName**](classReferencingFeatureListModel.md#property-attachmentfieldname-12)  <br> |
...
```C++
QString ReferencingFeatureListModel::attachmentFieldName;
```
...
Returns the field name of the first [**ExternalResource**](classExternalResource.md) field found on the referencing layer, or an empty string if no such field exists. 
